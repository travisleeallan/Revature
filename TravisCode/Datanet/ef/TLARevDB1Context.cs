...
{
    public partial class TLARevDB1Context : DbContext
    {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Server=tlarevdb1.database.windows.net;database=TLARevDB1;user id=tradmin;password=L0n3r1sm;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<email>(entity =>
            {
                ...
                entity.Property(e => e.ChangeDate).HasComputedColumnSql("(sysutcdatetime())");
